    ...
    <footer className="mt-24 border-t border-white/10">
      <div className="mx-auto max-w-7xl px-4 py-12 grid gap-8 md:grid-cols-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">A plataforma Roblox tudo-em-um: scripts, marketplace, executores e comunidade.</p>
        </div>
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            ...
            <li><Link to="/market" className="hover:text-foreground">Marketplace</Link></li>
            <li><Link to="/community" className="hover:text-foreground">Comunidade</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            <li><Link to="/shop" className="hover:text-foreground">Loja Smiiley</Link></li>
            <li><Link to="/points" className="hover:text-foreground">Sistema de Pontos</Link></li>
            <li><Link to="/support" className="hover:text-foreground">Central de Suporte</Link></li>
            <li><Link to="/sell" className="hover:text-foreground">Vender no Marketplace</Link></li>
          </ul>
        </div>
        <div>
